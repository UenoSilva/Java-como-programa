 ...
 */
public class Cilindro extends ThreeDimensionalShape{
    
    private double raio;
    private double altura;

    public Cilindro(String nome, String definicao, String descricao, double raio, double altura) {
    ...
    public double areaTotalDaSupercie(){
        return 2*Math.PI*getRaio()*(getAltura()+getRaio());
    }
    ...
    public String toString() {
        return String.format("%s%n%s%n%s %.2f%n%s %.2f%n%s %.2f%n%s %.2f%n%s", 
                ...
                "Raio:", getRaio(),
                "Altura:", getAltura(),
                "Área total da superficie:", areaTotalDaSupercie(),
                "Volume:", volume(),
                "------------------------------------------------------------------------");
    }
